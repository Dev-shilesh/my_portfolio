...
export default function Footer() {
    ...
    return (
        <footer className="bg-gray-900 text-white py-10 px-5 md:px-20">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-6 text-3xl">
                                <a href="https://github.com/shileshmavchi" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
                                    <FaGithub />
                                </a>
                                <a href="https://linkedin.com/in/shileshmavchi" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
                                    <FaLinkedin />
                                </a>
                                <a href="https://twitter.com/shileshmavchi" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
                                    <FaTwitter />
                                </a>
                                <a href="https://instagram.com/shileshmavchi" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
                                    <FaInstagram />
                                </a>
                                <a href="https://facebook.com/shileshmavchi" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
                                    <FaFacebook />
                                </a>
                                <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
                                    <FaWhatsapp />
                                </a>
                            </div>
                        </div>
            ...
            {/* Divider and Bottom */}
            <div className="mt-10 border-t border-gray-700 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-400">
